                            ...
                            <div class="col-sm-12">
                                <div class="form-group row">
                                    <div class="col-sm-9">
                                        ...
                                        <span class="help text-danger"></span>
                                        <input type="text" name="nama_barang" class="form-control" value="{{old('nama_barang', $data->nama_barang)}}">
                                        @error('nama_barang')
                                        <p class="hint-text small text-danger"><span class="fa fa-terminal"></span> {{$message}}</p>
                                        @enderror
                                        <br>
                                        ...
                                        <div class="summernote-wrapper">
                                            <textarea name="spesifikasi" id="summernote">{{old('spesifikasi', $data->spesifikasi)}}</textarea>
                                        </div>
                                    </div>
                                    <div class="col-sm-3">
                                        ...
                                        <div class="col-sm-12">
                                            <div class="row">
                                                <select name="kategori" class="form-control">
                                                    ...
                                                    <option value="{{$category->id}}" {{(old('kategori', $data->id_kategori) == $category->id) ? "selected" : ""}}>{{$category->nama_kategori}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        @enderror
                                        <div id="prevImage">
                                            <img src="{{url('images/barang/'.$data->gambar)}}" alt="" width="100%">
                                        </div>
                                        <br>
