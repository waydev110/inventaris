			...
			<div class="row p-l-15 p-r-15">
                <div class="col-md-8">
                    <div class="form-group">
                        <a href="{{url('administrator/barang/kategori/create')}}" class="btn btn-sm btn-success"><i class="fa fa-plus-circle"></i> Tambah {{$title}}</a>
                    </div>
                </div>
                <div class="col-md-4">
...
<script>
    ...
    $('body').on('click', ".submit", function () {
            ...
            $.ajax({
                url: "{{url('administrator/barang/kategori/delete')}}",
                type: 'POST',
